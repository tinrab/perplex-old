...
FVector UMCharacterMovementComponent::GetImpartedMovementBaseVelocity() const
{
...
void UMCharacterMovementComponent::JumpOff(AActor* MovementBaseActor)
{
...
FVector UMCharacterMovementComponent::GetBestDirectionOffActor(AActor* BaseActor) const
{
...
void UMCharacterMovementComponent::SetDefaultMovementMode()
{
...
void UMCharacterMovementComponent::PerformAirControlForPathFollowing(FVector Direction, float ZDiff)
{
...
void UMCharacterMovementComponent::PerformAirControlForPathFollowingEx(const FVector& MoveVelocity, const FVector& GravDir)
{
...
FVector UMCharacterMovementComponent::ConstrainAnimRootMotionVelocity(const FVector& RootMotionVelocity, const FVector& CurrentVelocity) const
{
...
void UMCharacterMovementComponent::SimulateMovement(float DeltaSeconds)
{
...
void UMCharacterMovementComponent::MaybeUpdateBasedMovement(float DeltaSeconds)
{
...
void UMCharacterMovementComponent::UpdateBasedMovement(float DeltaSeconds)
{
	if (!HasValidData())
	{
		return;
...
void UMCharacterMovementComponent::UpdateBasedRotation(FRotator& FinalRotation, const FRotator& ReducedRotation)
{
...
void UMCharacterMovementComponent::Crouch(bool bClientSimulation)
{
	if (!HasValidData())
	{
		return;
...
void UMCharacterMovementComponent::UnCrouch(bool bClientSimulation)
{
	if (!HasValidData())
	{
		return;
...
float UMCharacterMovementComponent::SlideAlongSurface(const FVector& Delta, float Time, const FVector& InNormal, FHitResult& Hit, bool bHandleImpact)
{
	if (!Hit.bBlockingHit)
	{
		return 0.0f;
...
void UMCharacterMovementComponent::TwoWallAdjust(FVector& Delta, const FHitResult& Hit, const FVector& OldHitNormal) const
{
...
FVector UMCharacterMovementComponent::HandleSlopeBoosting(const FVector& SlideResult, const FVector& Delta, const float Time, const FVector& Normal, const FHitResult& Hit) const
{
	const FVector CapsuleUp = GetComponentAxisZ();
...
float UMCharacterMovementComponent::ImmersionDepth() const
{
	float Depth = 0.0f;
...
void UMCharacterMovementComponent::RequestDirectMove(const FVector& MoveVelocity, bool bForceMaxSpeed)
{
...
float UMCharacterMovementComponent::GetMaxJumpHeight() const
{
...
void UMCharacterMovementComponent::PhysFlying(float deltaTime, int32 Iterations)
{
...
void UMCharacterMovementComponent::ApplyRootMotionToVelocityOVERRIDEN(float deltaTime)
{
...
void UMCharacterMovementComponent::PhysSwimming(float deltaTime, int32 Iterations)
{
	if (deltaTime < MIN_TICK_TIME)
	{
		return;
...
void UMCharacterMovementComponent::StartSwimmingOVERRIDEN(FVector OldLocation, FVector OldVelocity, float timeTick, float remainingTime, int32 Iterations)
{
...
FVector UMCharacterMovementComponent::GetFallingLateralAcceleration(float DeltaTime)
{
	return GetFallingLateralAccelerationEx(DeltaTime, GetGravityDirection(true));
}

FVector UMCharacterMovementComponent::GetFallingLateralAccelerationEx(float DeltaTime, const FVector& GravDir) const
{
...
FVector UMCharacterMovementComponent::GetAirControl(float DeltaTime, float TickAirControl, const FVector& FallAcceleration)
{
	return GetAirControlEx(DeltaTime, TickAirControl, FallAcceleration, GetGravityDirection(true));
}

FVector UMCharacterMovementComponent::GetAirControlEx(float DeltaTime, float TickAirControl, const FVector& FallAcceleration, const FVector& GravDir) const
{
	// Boost.
...
float UMCharacterMovementComponent::BoostAirControl(float DeltaTime, float TickAirControl, const FVector& FallAcceleration)
{
	return BoostAirControlEx(DeltaTime, TickAirControl, FallAcceleration, GetGravityDirection(true));
}

float UMCharacterMovementComponent::BoostAirControlEx(float DeltaTime, float TickAirControl, const FVector& FallAcceleration, const FVector& GravDir) const
{
...
void UMCharacterMovementComponent::PhysFalling(float deltaTime, int32 Iterations)
{
...
FVector UMCharacterMovementComponent::LimitAirControl(float DeltaTime, const FVector& FallAcceleration, const FHitResult& HitResult, bool bCheckForValidLandingSpot)
{
	return LimitAirControlEx(DeltaTime, FallAcceleration, HitResult, GetGravityDirection(true), bCheckForValidLandingSpot);
}

FVector UMCharacterMovementComponent::LimitAirControlEx(float DeltaTime, const FVector& FallAcceleration, const FHitResult& HitResult, const FVector& GravDir, bool bCheckForValidLandingSpot) const
{
...
bool UMCharacterMovementComponent::CheckLedgeDirection(const FVector& OldLocation, const FVector& SideStep, const FVector& GravDir) const
{
...
FVector UMCharacterMovementComponent::GetLedgeMove(const FVector& OldLocation, const FVector& Delta, const FVector& GravDir) const
{
...
void UMCharacterMovementComponent::StartFalling(int32 Iterations, float remainingTime, float timeTick, const FVector& Delta, const FVector& subLoc)
{
...
FVector UMCharacterMovementComponent::ComputeGroundMovementDelta(const FVector& Delta, const FHitResult& RampHit, const bool bHitFromLineTrace) const
{
	const FVector CapsuleUp = GetComponentAxisZ();
	return ComputeGroundMovementDeltaEx(FVector::VectorPlaneProject(Delta, CapsuleUp), CapsuleUp, RampHit, bHitFromLineTrace);
}

FVector UMCharacterMovementComponent::ComputeGroundMovementDeltaEx(const FVector& Delta, const FVector& DeltaPlaneNormal, const FHitResult& RampHit, const bool bHitFromLineTrace) const
{
...
void UMCharacterMovementComponent::MoveAlongFloor(const FVector& InVelocity, float DeltaSeconds, FStepDownResult* OutStepDownResult)
{
	if (!CurrentFloor.IsWalkableFloor())
	{
		return;
...
void UMCharacterMovementComponent::MaintainHorizontalGroundVelocity()
{
	if (bMaintainHorizontalGroundVelocity)
	{
...
void UMCharacterMovementComponent::PhysWalking(float deltaTime, int32 Iterations)
{
...
void UMCharacterMovementComponent::AdjustFloorHeight()
{
...
void UMCharacterMovementComponent::SetPostLandedPhysics(const FHitResult& Hit)
{
	if (CharacterOwner)
	{
		if (CanEverSwim() && IsInWater())
...
void UMCharacterMovementComponent::OnTeleported()
{
	if (!HasValidData())
	{
		return;
...
void UMCharacterMovementComponent::PhysicsRotation(float DeltaTime)
{
...
void UMCharacterMovementComponent::PhysicsVolumeChanged(class APhysicsVolume* NewVolume)
{
	if (!HasValidData())
	{
		return;
...
bool UMCharacterMovementComponent::ShouldJumpOutOfWater(FVector& JumpDir)
{
	return ShouldJumpOutOfWaterEx(JumpDir, GetGravityDirection(true));
}

bool UMCharacterMovementComponent::ShouldJumpOutOfWaterEx(FVector& JumpDir, const FVector& GravDir)
{
...
bool UMCharacterMovementComponent::CheckWaterJump(FVector CheckPoint, FVector& WallNormal)
{
	return CheckWaterJumpEx(CheckPoint, GetGravityDirection(true), WallNormal);
}

bool UMCharacterMovementComponent::CheckWaterJumpEx(FVector CheckPoint, const FVector& GravDir, FVector& WallNormal)
{
	if (!HasValidData())
	{
		return false;
...
void UMCharacterMovementComponent::MoveSmooth(const FVector& InVelocity, const float DeltaSeconds, FStepDownResult* OutStepDownResult)
{
	if (!HasValidData())
	{
		return;
...
bool UMCharacterMovementComponent::IsWithinEdgeTolerance(const FVector& CapsuleLocation, const FVector& TestImpactPoint, const float CapsuleRadius) const
{
	return IsWithinEdgeToleranceEx(CapsuleLocation, GetComponentAxisZ() * -1.0f, CapsuleRadius, TestImpactPoint);
}

bool UMCharacterMovementComponent::IsWithinEdgeToleranceEx(const FVector& CapsuleLocation, const FVector& CapsuleDown, const float CapsuleRadius, const FVector& TestImpactPoint) const
{
...
void UMCharacterMovementComponent::ComputeFloorDist(const FVector& CapsuleLocation, float LineDistance, float SweepDistance, FFindFloorResult& OutFloorResult, float SweepRadius, const FHitResult* DownwardSweepResult) const
{
...
bool UMCharacterMovementComponent::FloorSweepTest(FHitResult& OutHit, const FVector& Start, const FVector& End, ECollisionChannel TraceChannel,
...
bool UMCharacterMovementComponent::IsValidLandingSpot(const FVector& CapsuleLocation, const FHitResult& Hit) const
{
	if (!Hit.bBlockingHit)
	{
		return false;
...
bool UMCharacterMovementComponent::ShouldCheckForValidLandingSpot(float DeltaTime, const FVector& Delta, const FHitResult& Hit) const
{
	const FVector CapsuleUp = GetComponentAxisZ();
...
bool UMCharacterMovementComponent::ShouldComputePerchResult(const FHitResult& InHit, bool bCheckRadius) const
{
...
bool UMCharacterMovementComponent::ComputePerchResult(const float TestRadius, const FHitResult& InHit, const float InMaxFloorDist, FFindFloorResult& OutPerchFloorResult) const
{
...
bool UMCharacterMovementComponent::StepUp(const FVector& GravDir, const FVector& Delta, const FHitResult& InHit, struct UCharacterMovementComponent::FStepDownResult* OutStepDownResult)
{
...
void UMCharacterMovementComponent::HandleImpact(const FHitResult& Impact, float TimeSlice, const FVector& MoveDelta)
{
	if (CharacterOwner)
	{
...
void UMCharacterMovementComponent::ApplyImpactPhysicsForces(const FHitResult& Impact, const FVector& ImpactAcceleration, const FVector& ImpactVelocity)
{
...
void UMCharacterMovementComponent::DisplayDebug(UCanvas* Canvas, const FDebugDisplayInfo& DebugDisplay, float& YL, float& YPos)
{
...
void UMCharacterMovementComponent::VisualizeMovement() const
{
...
FVector UMCharacterMovementComponent::ConstrainInputAcceleration(const FVector& InputAcceleration) const
{
...
void UMCharacterMovementComponent::ServerMoveHandleClientError(float ClientTimeStamp, float DeltaTime, const FVector& Accel, const FVector& RelativeClientLoc, UPrimitiveComponent* ClientMovementBase, FName ClientBaseBoneName, uint8 ClientMovementMode)
{
...
void UMCharacterMovementComponent::ClientAdjustPosition_Implementation(float TimeStamp, FVector NewLocation, FVector NewVelocity, UPrimitiveComponent* NewBase, FName NewBaseBoneName, bool bHasBase, bool bBaseRelativePosition, uint8 ServerMovementMode)
{
...
void UMCharacterMovementComponent::CapsuleTouched(UPrimitiveComponent* OverlappedComp, AActor* Other, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (!bEnablePhysicsInteraction)
	{
		return;
...
void UMCharacterMovementComponent::ApplyDownwardForce(float DeltaSeconds)
{
...
void UMCharacterMovementComponent::ApplyRepulsionForce(float DeltaSeconds)
{
...
void UMCharacterMovementComponent::ApplyAccumulatedForces(float DeltaSeconds)
{
...
FVector UMCharacterMovementComponent::GetGravity() const
{
...
FVector UMCharacterMovementComponent::GetGravityDirection(bool bAvoidZeroGravity) const
{
...
float UMCharacterMovementComponent::GetGravityMagnitude() const
{
	return FMath::Abs(GetGravityZ());
}

void UMCharacterMovementComponent::SetGravityDirection(const FVector& NewGravityDirection)
{
	SetCustomGravityDirection(NewGravityDirection.GetSafeNormal());
}

FORCEINLINE void UMCharacterMovementComponent::SetCustomGravityDirection(const FVector& NewCustomGravityDirection)
{
...
void UMCharacterMovementComponent::ClientSetCustomGravityDirection_Implementation(const FVector& NewCustomGravityDirection)
{
	SetCustomGravityDirection(NewCustomGravityDirection);
}

void UMCharacterMovementComponent::ClientClearCustomGravityDirection_Implementation()
{
	SetCustomGravityDirection(FVector::ZeroVector);
}

void UMCharacterMovementComponent::ClientSetGravityPoint_Implementation(const FVector& NewGravityPoint)
{
	GravityPoint = NewGravityPoint;
}

void UMCharacterMovementComponent::ClientClearGravityPoint_Implementation()
{
	GravityPoint = FVector::ZeroVector;
}

void UMCharacterMovementComponent::ClientSetGravityScale_Implementation(float NewGravityScale)
{
	GravityScale = NewGravityScale;
}

void UMCharacterMovementComponent::UpdateGravity(float DeltaTime)
{
...
FRotator UMCharacterMovementComponent::ConstrainComponentRotation(const FRotator& Rotation) const
{
...
FORCEINLINE FVector UMCharacterMovementComponent::GetComponentAxisX() const
{
...
FORCEINLINE FVector UMCharacterMovementComponent::GetComponentAxisZ() const
{
...
FVector UMCharacterMovementComponent::GetComponentDesiredAxisZ() const
{
...
void UMCharacterMovementComponent::UpdateComponentRotation()
{
	if (!HasValidData())
	{
		return;
